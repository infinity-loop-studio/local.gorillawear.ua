...
class jshopUserShop extends jshopUserShopBase{
	...
	function addUserToTableShop($user){
		...
		$db->query();
		$obj = $this;
        JDispatcher::getInstance()->trigger('onAfterAddUserToTableShop', array(&$obj));
	}
    ...
    function store($updateNulls = false){
		...
		$obj = $this;
        JDispatcher::getInstance()->trigger('onBeforeStoreTableShop', array(&$obj));
    ...
    function getNewUserNumber(){
        $number = $this->user_id;
		$obj = $this;
        JDispatcher::getInstance()->trigger('onBeforeGetNewUserNumber', array(&$obj, &$number));
        return $number;
    }
